package com.desen.desenmall.cart.controller;
...
public class CartController {
    ...
    private final String PATH = "redirect:http://cart.desenmall.com/cart.html";
    private final String SUCCESS_PATH = "redirect:http://cart.desenmall.com/addToCartSuccess.html";
     ...
     * 	   addFlashAttribute()，将数据放在session中，可以在页面取出，但只能取一次
     * 	   addAttribute()，将数据添加到url后面
     */
