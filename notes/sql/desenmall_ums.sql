...
Source Database       : desenmall_ums

Target Server Type    : MYSQL
Target Server Version : 50733
File Encoding         : 65001

Date: 2021-08-29 18:18:20
*/
...
CREATE TABLE `ums_member` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='会员';

-- ----------------------------
-- Records of ums_member
-- ----------------------------
INSERT INTO `ums_member` VALUES ('5', '1', 'yangminglin', '$2a$10$lyAvcijt6vcNlqDZK2YKfuAjbI4jiwJB0r/zesWbHJchLqMHfxl1m', 'yangminglin', '13670770751', 'xxx@gmail.com', null, '1', '2021-08-29', '广东深圳 ', 'JAVA', null, null, null, null, '0', '2021-08-29 15:59:18', null, null, null);
INSERT INTO `ums_member` VALUES ('6', '1', 'yml2016', null, '待什君', null, '504945613@qq.com', 'https://avatars.githubusercontent.com/u/23615752?v=4', null, '2021-08-29', '中国啊啊啊', 'no cy', '非身强无以负重，非志坚无以行远', null, null, null, '0', '2021-08-29 16:01:33', '23615752', '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', null);
...
CREATE TABLE `ums_member_receive_address` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='会员收货地址';

-- ----------------------------
-- Records of ums_member_receive_address
-- ----------------------------
INSERT INTO `ums_member_receive_address` VALUES ('1', '4', 'yangminlin', '18173516208', null, '广东', '潮州', null, '饶平', null, '1');
INSERT INTO `ums_member_receive_address` VALUES ('2', '5', 'yml2016', '18173516102', null, '湖南', '长沙', null, '雨花区', null, '1');
