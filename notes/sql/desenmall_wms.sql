...
Source Database       : desenmall_wms

Target Server Type    : MYSQL
Target Server Version : 50733
File Encoding         : 65001

Date: 2021-08-29 18:19:44
*/
...
CREATE TABLE `wms_purchase` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='采购信息';
...
-- ----------------------------
INSERT INTO `wms_ware_info` VALUES ('1', '1号仓库', '深圳市南山区', '580000');
...
CREATE TABLE `wms_ware_order_task` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='库存工作单';
...
INSERT INTO `wms_ware_order_task` VALUES ('3', null, '202108291611580031431892366075191298', null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `wms_ware_order_task` VALUES ('7', null, '202108291616225591431893475699286017', null, null, null, null, null, null, null, null, null, null, null);
...
INSERT INTO `wms_ware_order_task_detail` VALUES ('3', '2', '', '1', '3', '1', '2');
INSERT INTO `wms_ware_order_task_detail` VALUES ('7', '2', '', '1', '7', '1', '2');
